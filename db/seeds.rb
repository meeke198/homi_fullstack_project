...
product2 = Product.create!(product_name: "Natural color linen cover for toddler bed", description: "Add a modern touch to your toddlers house shape bed with our linen covers!" , category: "bedframe", price: 75.22, seller_id: 2)
...
product4 = Product.create!(product_name: "Tepee House Bed", description: "Adventure awaits with the Teepee full tent complete bed in a box.", category: "bedframe", price: 290, seller_id: 4)
...
product5 = Product.create!(product_name: "Lucinda Luxurious 6 Piece 100% Cotton Towel Set", description: "Pamper yourself with the luxurious weight of 600gsm towels and washcloths when you use these cotton towels.", category: "towel", price: 22.21, seller_id: 5)
...
product7 = Product.create!(product_name: "Funny Dish Towels", description: "Are you looking for a unique gift for someone special? Our personalized kitchen towels are the gift for you!! ", category: "dinning table", price: 11.77, seller_id: 7)
...
product8 = Product.create!(product_name: "Natural linen table runner", description: "STRIPED linen table runner - natural linen table runner - light white beige table runner - handmade linen table runner", category: "dinning table", price: 22.19, seller_id: 8)
...
product10 = Product.create!(product_name: "REGULAR Two Tone Tray ", description: "THE CRAFTY SWIRL is expanding its two tone collection!", category: "dinning table", price: 80.21, seller_id: 10)
...
product11 = Product.create!(product_name: "Wood World Map Wall Art Wood Large Wall Decor Travel Home Decor", description: "Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, ", category: "wallart", price: 22.46, seller_id: 11)
...
product12 = Product.create!(product_name: "Family Last Name Sign for Personalized Wedding", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ", category: "wallart", price: 41.19, seller_id: 12)
...
product13 = Product.create!(product_name: "Wine Bottle Bag - Personalized Wine Gift Bag", description: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum", category: "wallart", price: 20.15, seller_id: 13)
...
product15 = Product.create!(product_name: "Large Hexagon shelf, hexagon shelves", description: "Endless possibilities await with these custom finished shelves.", category: "wallart", price: 31.21, seller_id: 15)
...
# mirror1 = URI.open("https://homi-seeds.s3.us-east-2.amazonaws.com/vase4.jpg")
...
# product56 = Product.create!(product_name: "Boho Reclaimed Wood Dining Table & Bench, Dining Table Set", description: "This contemporary yet rustic dining table is versatile with different chairs and is as fitting in an apartment as it is in a rustic log cabin.", category: "cutting board", price: 101.77, seller_id: 56)
...
# product58 = Product.create!(product_name: "Kitchen stool Safety", description: "The kitchen step stool, safety stool, or kids step stool is an adjustable kitchen chair or Montessori tower for toddlers. ", category: "cutting board", price: 55.99, seller_id: 58)
...
# product59 = Product.create!(product_name: "Assorted Colorful Succulents Plants / Potted", description: "Nordic home furnishing creative decoration wine cabinet sample room soft decoration living room coffee table vestibule art vase", category: "plant", price: 107.25, seller_id: 59)
...
# product60 = Product.create!(product_name: "3 VARIEGATED 'Thai Snow' IXORA Live Well- Rooted Starter Plants", description: "This contemporary yet rustic dining table is versatile with different chairs and is as fitting in an apartment as it is in a rustic log cabin.", category: "plant", price: 101.77, seller_id: 60)
...
# product61 = Product.create!(product_name: "Mini Terrarium Plants (6 Plants)", description: "In your lounge, in your hallway, placed over a radiator or even in your bathroom; this stunning slimline reclaimed timber console table is perfect for any room in your home.", category: "plant", price: 75.19, seller_id: 61)
...
# product62 = Product.create!(product_name: "Alocasia Baginda Dragon Scale", description: "The kitchen step stool, safety stool, or kids step stool is an adjustable kitchen chair or Montessori tower for toddlers. ", category: "plant", price: 55.99, seller_id: 62)
