...
bedframe1 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/bedframe1.webq")
...
bedframe2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/bedframe2.jpg")
...
bedframe3 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/bedframe3.jpg")
...
bedframe4 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/bedroom4.jpg")
...
bath2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/bath2.jpg")
...
kitchen1 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/kitchen1.webp")
...
kitchen2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/kitchen2.webp")
...
kitchen3 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/kitchen3.webp")
...
kitchen4 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/kitchen4.webp")
...
kitchen5 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/kitchen5.webp")
...
walldecor1 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/walldecor1.jpg")
...
walldecor2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/walldecor2.jpg")
...
walldecor3 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/walldecor3.jpg")
...
walldecor4 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/walldecor4.jpg")
...
walldecor5 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/walldecor5.jpg")
...
vase1 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/vase1.jpg")
...
vase2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/vase2.jpg")
...
vase3 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/vase3.jpg")
...
vase4 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/vase4.jpg")
...
livingroom1 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/livingroom1.jpg")
product20.photo.attach(io: livingroom1, filename:"livingroom1.jpg")

product21 = Product.create!(product_name: "Floating Shelf Rustic Shelf Ledge Shelf Open Shelving", description: "Amazing kids' teepee wood house beds for children.", price: 200, seller_id: 16)
livingroom2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/livingroom2.jpg")
bedframe1.photo.attach(io: bedframe1, filename:"livingroom2.jpg")

product22 = Product.create!(product_name: "Floating Reclaimed Wood Shelves", description: "It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages", price: 22.13, seller_id: 2)
livingroom3 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/livingroom3.jpg")
product17.photo.attach(io: livingroom3, filename:"livingroom3.jpg")

product23 = Product.create!(product_name: "Rustic Floating Shelves Industrial ", description: "Our floating shelf adds a rustic farmhouse open storage solution to your home or work space." , price: 37.25, seller_id: 2)
livingroom4 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/livingroom4.jpg")
product18.photo.attach(io: livingroom4, filename:"livingroom4.jpg")

product24 = Product.create!(product_name: "MOSS GREEN linen table runner", description: "MOSS GREEN linen table runner - heavier linen olive green linen table runner - military green table runner - handmade linen table runner", price: 34.21, seller_id: 15)
livingroom5 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/livingroom5.webp")
product19.photo.attach(io: livingroom5, filename:"livingroom5.webq")

product25 = Product.create!(product_name: "Heavenly Angel Solar Powered Led Outdoor Decor Garden Light", description: "Solar Powered LED Outdoor Garden Light - Great addition for your garden!", price: 15.21, seller_id: 20)
garden1 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/gargen1.webp")
product20.photo.attach(io: garden1, filename:"garden1.webq")

product26 = Product.create!(product_name: "Solar Powered LED Outdoor Garden Light - Great addition for your garden!", description: "Captures the essence of nature at rest with this lifelike fox pup figure taking time out from his busy day to sleep.", price: 32.99, seller_id: 11)
garden2 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/garden2.webp")
product20.photo.attach(io: garden2, filename:"garden2.webq")

product27 = Product.create!(product_name: "Rain Slicker Frog Statue", description: "Theme: Animal", price: 38.21, seller_id: 10)
garden3 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/garden3.webp")
product20.photo.attach(io: garden3, filename:"garden3.webq")

product28 = Product.create!(product_name: "Cherubs Of Contemplation Angel Statue", description: "If you can't sneak a catnap for yourself, you'll envy this feathered fellow's sweet repose in your home or garden. ", price: 34.21, seller_id: 20)
garden4 = open("https://homi-seeds.s3.us-east-2.amazonaws.com/garden4.webp")
